...
def chi_star(
    ...
    def deriv_func(d=d,W=W, P=P, lambda_=lambda_, M_G=M_G, chi=chi,
        ...
        '''
            ...
            Note: wherever there was grad(P) grad(chi) was put instead.
...
if __name__ == '__main__':
    ...
    proxy = load('/home/raid3/vonhof/Documents/Riccardo_Data/230317/phantom_32_phs.nii.gz')
    # execute whole function (with two sub-functions)
    chi = chi_star(f=proxy, chi=proxy)
    save('/home/raid3/vonhof/Documents/Riccardo_Data/230317/phantom_32_chi_appendix.nii.gz', chi)
